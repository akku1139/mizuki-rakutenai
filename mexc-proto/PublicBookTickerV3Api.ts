...
export class PublicBookTickerV3Api extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static fromObject(data: {
        ...
        const message = new PublicBookTickerV3Api({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PublicBookTickerV3Api {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PublicBookTickerV3Api();
    ...
    static deserializeBinary(bytes: Uint8Array): PublicBookTickerV3Api {
        return PublicBookTickerV3Api.deserialize(bytes);
    }
}
